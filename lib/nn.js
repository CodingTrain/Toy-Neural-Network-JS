...
class NeuralNetwork {
  ...
  train(input_array, target_array) {
    ...
    if (this.activation_function.use_X_values) {
      let xHidden = Matrix.duplicate(hidden)
    }
    // activation function!
    hidden.map(this.activation_function.func);
    ...
    if (this.activation_function.use_X_values) {
      let xOutputs = Matrix.duplicate(outputs)
    }
    ...
    // Calculate gradient
    if (this.activation_function.use_X_values) {
      let gradients = Matrix.map(xOutputs, this.activation_function.dfunc);
    } else {
    ...
    if (this.activation_function.use_X_values) {
      let hidden_gradient = Matrix.map(xHidden, this.activation_function.dfunc);
    } else {
