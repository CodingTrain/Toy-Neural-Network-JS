...
- [Toy Neural Network Library in p5.js with multiple hidden layers](https://github.com/therealyubraj/NerualNetworkJS) by [Yubraj Sharma](https://github.com/therealyubraj)
