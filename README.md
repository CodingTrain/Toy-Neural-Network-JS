...
- [C++ Neural Network Library](https://github.com/ensismoebius/mestrado/blob/master/src/lib/classifiers/NeuralNetwork.cpp) by [ensismoebius](https://github.com/ensismoebius)
